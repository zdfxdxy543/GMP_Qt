...
class ConfigWizard(QWizard):
    ...
    def generate_ctrl_settings_header(self, targetFolder):
        ...
        header_content += "// Compare output enable reg mask CCER (CH1/CH1N, CH2/CH2N, CH3/CH3N)\n"
        header_content += """#define TIM_CCER_MASK  (TIM_CCER_CC1E | TIM_CCER_CC1NE | \\
