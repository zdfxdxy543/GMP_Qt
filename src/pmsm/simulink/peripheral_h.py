...
class ConfigWizard(QWizard):
    ...
    def generate_ctrl_settings_header(self, targetFolder):
        ...
        header_content += "#ifndef _FILE_XPLT_PERIPHERAL_H_\n#define _FILE_XPLT_PERIPHERAL_H_\n\n"
        ...
        # 写入文件到目标文件夹
        file_path = os.path.join(targetFolder, "xplt.peripheral.h")
        with open(file_path, "w", encoding="utf-8") as f:
            f.write(filled_content)

        print(f"xplt.peripheral.h头文件已生成到: {file_path}")
