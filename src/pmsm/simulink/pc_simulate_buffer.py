...
class ConfigWizard(QWizard):
    ...
    uint32_t udc;\n\n    // DC bus current\n    uint32_t idc;\n\n    // encoder feedback\n    uint32_t encoder;\n\n    int32_t revolution;\n\n} rx_buf_t;\n#pragma pack()\n\n"""
        ...
        # 写入文件到目标文件夹
        file_path = os.path.join(targetFolder, "pc_simulate_buffer.h")
        with open(file_path, "w", encoding="utf-8") as f:
            f.write(filled_content)

        print(f"pc_simulate_buffer.h头文件已生成到: {file_path}")
